 ...
 */
class LEO_VCU_DRIVER_PUBLIC AsyncSerialImpl;

/**
 * Asyncronous serial class.
 * Intended to be a base class.
 */
class LEO_VCU_DRIVER_PUBLIC AsyncSerial: private boost::noncopyable
{
public:
  AsyncSerial();
 ...
 */
class LEO_VCU_DRIVER_PUBLIC CallbackAsyncSerial: public AsyncSerial
{
public:
  CallbackAsyncSerial();
